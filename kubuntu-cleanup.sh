...
nala purge -y libreoffice* elisa ktorrent thunderbird konversation krdc kmahjongg ksudoku xserver-xorg-input-wacom kate plasma-discover im-config imagemagick-6.q16
nala autopurge -y
